...
group_id = "1488511748129645"

# input date formatted as YYYY-MM-DD
since_date = ""
until_date = ""

access_token= 'EAACZCGzCLR30BAK2bI6BvzVvUHa5jhZBHzhbavXIIi4XwaA8K8GvU3gZAdhhYquhowuJUWOfbjanITbKyqLWJlSzN9yGNM7Ov11C5ORWRzGHzrXmfGxTGYJCzMVtZBwh2zs9tI4jtMGBA9tZBuhdJcduOa2ArHdMZD'
        ...
        while has_next_page:
            ...
            for status in statuses['data']:
                ...
                if 'reactions' in status:
                    status_data, reactions_ = processFacebookPageFeedStatus(status)
                    reactions_data = reactions[status_data[0]]

                    # calculate thankful/pride through algebra
                    num_special = status_data[8] - sum(reactions_data)
                    # print(reactions_)
                    w.writerow(status_data + reactions_data + (num_special,) + (reactions_,))
